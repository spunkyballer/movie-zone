...
<nav class="navbar navbar-expand-md navbar-light" id="navbar_sticky">
 ...
 <div class="main_team clearfix">
   <section id="center" class="center_blog">
     <div class="container-xl">
  <div class="row center_o1">
   <div class="col-md-12">
      <h2 class="text-white">Team</h2>
	  <h6 class="mb-0 mt-3 fw-normal col_red"><a class="text-light" href="#">Home</a> <span class="mx-2 text-muted">/</span> Team</h6>
   </div>
  </div>
 </div>
  </section>
 ...
 <div class="container-xl">
    <div class="events_1i row">
	    <div class="col-md-4">
		 ...
		 <div class="events_1i2 clearfix p-3 bg-light text-center">
